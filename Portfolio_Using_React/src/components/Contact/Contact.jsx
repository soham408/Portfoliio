...
function Contact (){
    return (
       ...
       <div className='pl-[28px]'>
        ...
        <h1 className='text-white text-[30px] flex items-center justify-center'><strong> 
            Get In Touch : 
            </strong><br /></h1>
        <h3 className='text-white flex items-center justify-center flex flex-col'>
        ...
        <div className='flex items-center justify-center space-x-2 mt-6'>
            ...
            viewBox="0 0 384 512">
                ...
                <div className='text-white'> Thane Maharashtra
                     </div>    
        </div>
        ...
        <div className='flex items-center justify-center space-x-2 '>
            ...
            viewBox="0 0 512 512">
                ...
                <div className='text-white'> 9112260488
                     </div>    
        </div>
        ...
        <div className='flex items-center justify-center space-x-2 '>
            ...
            viewBox="0 0 512 512">
                ...
                <div className='text-white'> slbambade01@gmail.com
                     </div>    
        </div>
        </div>
